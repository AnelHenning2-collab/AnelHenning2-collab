...
### Security & Networking
<p>
  <img src="https://img.shields.io/badge/CompTIA_Security%2B-FF0000?style=for-the-badge&logo=comptia&logoColor=white" alt="Security+"/>
  <img src="https://img.shields.io/badge/MITRE_ATT%26CK-003087?style=for-the-badge&logo=shield&logoColor=white" alt="MITRE ATT&CK"/>
...
### [2019 Adobe XD Daily Challenge — January ↗](https://www.behance.net/gallery/75269197/2019-Adobe-XD-Daily-Challenge)

<img src="assets/ux/bh-09-xd-jan2019.jpg" width="100%" alt="XD Daily January 2019"/>

**Tools:** Adobe XD (layout, interactive prototype) &nbsp;|&nbsp; **Devices:** iPhone · Apple Watch · Desktop (Mac & PC) &nbsp;|&nbsp; **Published:** 2019

Advanced prototype-focused challenge series emphasizing gesture interactions, smart home, finance, and wearable UX:

- **Day 1 — Pull to Refresh:** Designed and prototyped a *pull to refresh* experience for a photo sharing app
- **Day 2 — Drag to Rearrange:** *Drag to rearrange* web experience for an image grid layout
- **Day 3 — Smart Home App:** Dimming a smart bulb — home automation UI prototype
- **Day 4 — Color by Number Mobile App:** Gamified coloring experience on mobile
- **Days 5–6 — Send Cash by Voice (Apple Watch):** Voice-command cash sending on Apple Watch — wearable fintech UX
- **Day 7 — Mobile Notification Lock Screen:** Lock screen notification experience design
- **Day 7 (alt) — Finance App Chart:** Interactive finance chart experience — data visualization on mobile
- **Day 8 — Swipe to Edit Email:** Email client swipe-to-edit interaction design

---

### [March 2019: XD Daily Challenge — Music Player ↗](https://www.behance.net/gallery/76538083/March-2019-XD-Daily-Challenge)

<img src="assets/ux/bh-10-xd-mar2019.jpg" width="100%" alt="XD Daily March 2019"/>

**Tools:** Adobe XD (design system, prototype, development handoff) &nbsp;|&nbsp; **Devices:** Mobile (iPhone) &nbsp;|&nbsp; **Color Palette:** Living Coral · Almost Black · Bright Relish · Grey Blues &nbsp;|&nbsp; **Published:** 2019

8-day end-to-end product design sprint for a **music player mobile app** — the most complete design system challenge in the series:

- **Day 1 — Design System:** Color palette (Living Coral, Almost Black, Bright Relish, Grey Blues), typography (Title 1/2/3 hierarchy), component library, linked symbols, and file specifications
- **Day 2 — Low-Fidelity Artboards:** Blocked out core screens — splash, login, home, playlist, and library
- **Day 3 — User Flow:** Wired artboards into a complete user flow diagram focused on UX navigation architecture
- **Day 4 — Share & Review:** Published to Behance for peer feedback; reviewed other designers' work
- **Day 5 — High-Fidelity Screens:** Refined splash, login, and homepage using design system components and peer feedback
- **Day 6 — Finish Hi-Fi:** Playlist and now-playing screens — layers panel, repeat grids, overlays, linked symbols
- **Day 7 — Development Handoff:** Marked assets for export, shared for engineering review on web
- **Day 8 — Client Presentation:** Storytelling, context, and interactivity — full Behance case study format
...
**Tools:** Adobe Photoshop · Adobe Illustrator · Adobe Capture · Adobe Stock &nbsp;|&nbsp; **Brands:** Rare Summit · The Great Escape · The Fillmore &nbsp;|&nbsp; **Published:** 2019

9-day Photoshop mastery challenge — each day a focused Photoshop technique:

- **Day 1 — Blending:** Created a winter-inspired image (*Rare Summit Dec 28, 2018*) — layer manipulation with blend modes
- **Day 2 — Layers:** Built and moved layers to create beautiful imagery — opacity and texture experimentation
- **Day 3 — Templates:** Designed and mocked up a book cover using an Adobe Stock template
- **Day 4 — Collage:** Built a digital collage from found imagery using selection tools and puppet warp
- **Day 5 — Composite:** Magazine cover compositing — cut, manipulate, and combine imagery for a unique editorial image
- **Day 6 — Type & Texture:** Postcard design — letterform manipulation and texture brushes; abstract vector background with **Adobe Capture** brushes
- **Day 7 — Pen Tool:** Custom vector shape creation with the Photoshop pen tool
- **Day 8 — Channel:** Advanced masking using channel techniques
- **Day 9 — Double Exposure:** Double-exposure composite for **The Great Escape** / **The Fillmore** — two-image merged portrait technique
...
**Tools:** Adobe Photoshop CC · Photoshop smart filters · GIF animation &nbsp;|&nbsp; **App/Brand:** Level Up (fictional video game) &nbsp;|&nbsp; **Published:** 2019

9-day Photoshop challenge series — from layering basics to GIF animation:

- **Day 1 — Layers:** Game night invitation — layered shapes and text in Photoshop
- **Day 2 — Blending:** Futuristic postcard using blending modes — level-up aesthetic
- **Day 3 — Type Effects:** Logo for fictional video game **"Level Up"** — glitch and neon text effects
- **Day 4 — Composite:** Space-themed dreamscape header image for social media — combined imagery and composition
- **Day 5 — Mockup:** Mocked up the Day 4 dreamscape for a fictional client — image retouching for realism
- **Day 6 — Filters:** Added movement to a poster using *path blur* as a smart filter
- **Day 7 — Textures:** Added texture to the poster using custom Photoshop CC brushes
- **Day 8 — Transform Tools:** Character adjustment with puppet warp and transform tools
- **Day 9 — Animate GIF:** Created a GIF animation from illustrations in Photoshop CC
